...
Servo myservo;
int numero,i,j,k,boton,r,b,z,util,bien,p=0;
bool Almaceno=false;
int tolerancia = 3;
bool CambiaContra=false;
bool cambiar=false;
int contra[4];
int correcta[4]={3,3,3,3};           //Contraseña la cual cargamos despues, tiene los 3333 porque tiene que estar cargado pero puede ser cualquier valor
    ...
    if (i==4){
        ...
        {            
            ...
            {     
               ...
               else                                        //Cada vez que el numero ingresado este mal, se reinicia la variable k asi no se acumulan estos datos para un futuro
               {
                   k=0;
                   contra[k]=0;
...
void NuevoTeclado()
{
    ...
    {     
      ...
      else                                             //error si el numero ingresado es 8888 ya que el ultimo digito al ser correcto no se reinicia la variable
      {
          k=0;                                        //Cada vez que el numero ingresado este mal, se reinicia la variable k asi no se acumulan estos datos para un futuro
          contra[k]=0;
          Serial.println("Digito Mal");
          lcd.clear();
          b++;
